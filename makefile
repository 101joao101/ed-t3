siguel: siguel.o Estoque.o Retangulo.o Circulo.o CalculoCirculoRetangulo.o Comandos.o Lista.o Quadra.o Semaforo.o Torre.o Hidrante.o Svg.o Ordenacao.o Elemento.o
	gcc -o siguel siguel.o Estoque.o Circulo.o Retangulo.o CalculoCirculoRetangulo.o Comandos.o Lista.o Quadra.o Semaforo.o Torre.o Hidrante.o Svg.o Ordenacao.o Elemento.o -lm -std=c99 -fstack-protector-all
siguel.o: siguel.c
...
Estoque.o: Estoque.c Estoque.h
	gcc -o Estoque.o -c Estoque.c -g -std=c99 -fstack-protector-all
